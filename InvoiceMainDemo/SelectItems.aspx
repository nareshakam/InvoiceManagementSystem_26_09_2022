...
<body>
    <form id="form1" runat="server">
        <div style="margin-left: 63px">
            <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Text="Naresh General Store"></asp:Label>
        </div>
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="BtnPayLater" runat="server" Text="Scearch Invoice" OnClick="BtnPayLater_Click" />
&nbsp;</form>
</body>
</html>
